...
@Slf4j
@Component
public class IpSingleExecutor extends IpBaseExecutor {
    ...
    public boolean execute(String currentIp, BufferedWriter bw, ProxyIp proxy,
                           IpBreakpoint breakpoint) throws IOException {
